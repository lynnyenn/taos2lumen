...
(function() {
    var t = this,
        n = function() {
            ...
            function e(t, n) {
                var e;
                for (e in t) Object.hasOwnProperty.call(t, e) && n(e)
            }
            ...
            function o(t, n, e, i, r, o, u) {
                var s, c, h, p = o > t ? 0 : (t - o) / r;
                for (s in n) n.hasOwnProperty(s) && (c = u[s], h = "function" == typeof c ? c : f[c], n[s] = a(e[s], i[s], h, p));
                return n
            }
            ...
            function u(t, n) {
                var i = h.prototype.filter,
                    r = t._filterArgs;
                e(i, function(e) {
                    i[e][n] !== void 0 && i[e][n].apply(t, r)
                })
            }

            function s(t, n, e, i, r, a, s, c, h, f, p) {
                g = n + e + i, y = Math.min(p || d(), g), v = y >= g, M = i - (g - y), t.isPlaying() && !v ? (t._scheduleId = f(t._timeoutHandler, m), u(t, "beforeTween"), n + e > y ? o(1, r, a, s, 1, 1, c) : o(y, r, a, s, i, n + e, c), u(t, "afterTween"), h(r, t._attachment, M)) : t.isPlaying() && v && (h(s, t._attachment, M), t.stop(!0))
            }

            function c(t, n) {
                var i = {},
                    r = typeof n;
                return "string" === r || "function" === r ? e(t, function(t) {
                    i[t] = n
                }) : e(t, function(t) {
                    i[t] || (i[t] = n[t] || l)
                }), i
            ...
            function h(t, n) {
                this._currentState = t || {}, this._configured = !1, this._scheduleFunction = p, n !== void 0 && this.setConfig(n)
            }
            var f, p, l = "linear",
                _ = 500,
                m = 1e3 / 60,
                w = Date.now ? Date.now : function() {
                    return +new Date
                },
                d = "undefined" != typeof SHIFTY_DEBUG_NOW ? SHIFTY_DEBUG_NOW : w;
            ...
            return h.prototype.tween = function(t) {
                return this._isTweening ? this : (void 0 === t && this._configured || this.setConfig(t), this._timestamp = d(), this._start(this.get(), this._attachment), this.resume())
                ...
                this._timeoutHandler = function() {
                    s(e, e._timestamp, e._delay, e._duration, e._currentState, e._originalState, e._targetState, e._easing, e._step, e._scheduleFunction)
                };
                var o = this._currentState,
                    a = this._targetState;
                return r(a, o), this._easing = c(o, t.easing || l), this._filterArgs = [o, this._originalState, a, this._easing], u(this, "tweenCreated"), this
            }, h.prototype.get = function() {
                return i({}, this._currentState)
            }, h.prototype.set = function(t) {
                this._currentState = t
            }, h.prototype.pause = function() {
                return this._pausedAtTime = d(), this._isPaused = !0, this
            }, h.prototype.resume = function() {
                return this._isPaused && (this._timestamp += d() - this._pausedAtTime), this._isPaused = !1, this._isTweening = !0, this._timeoutHandler(), this
            }, h.prototype.seek = function(t) {
                t = Math.max(t, 0);
                var n = d();
                return 0 === this._timestamp + t ? this : (this._timestamp = n - t, this.isPlaying() || (this._isTweening = !0, this._isPaused = !1, s(this, this._timestamp, this._delay, this._duration, this._currentState, this._originalState, this._targetState, this._easing, this._step, this._scheduleFunction, n), this.pause()), this)
            ...
            }), "function" == typeof SHIFTY_DEBUG_NOW && (t.timeoutHandler = s), "object" == typeof exports ? module.exports = h : "function" == typeof define && define.amd ? define('ngTweenable', function() {
                return h
            }) : t.NGTweenable === void 0 && (t.NGTweenable = h), h
        }();
    (function() {
        n.shallowCopy(n.prototype.formula, {
            ...
            easeInOutBack: function(t) {
                var n = 1.70158;
                return 1 > (t /= .5) ? .5 * t * t * (((n *= 1.525) + 1) * t - n) : .5 * ((t -= 2) * t * (((n *= 1.525) + 1) * t + n) + 2)
            },
            elastic: function(t) {
    ...
    function() {
        function t(t, n, e, i, r, o) {
            ...
            function p(t, n) {
                var e, i, r, o, u, c;
                for (r = t, c = 0; 8 > c; c++) {
                    if (o = a(r) - t, n > f(o)) return r;
                    if (u = s(r), 1e-6 > f(u)) break;
                    r -= o / u
                }
                if (e = 0, i = 1, r = t, e > r) return e;
                if (r > i) return i;
                for (; i > e;) {
                    if (o = a(r), n > f(o - t)) return r;
                    t > o ? e = r : i = r, r = .5 * (i - e) + e
                }
                return r
            }
            var l = 0,
                ...
                d = 0,
                g = 0;
            return m = 3 * n, _ = 3 * (i - n) - m, l = 1 - m - _, g = 3 * e, d = 3 * (r - e) - g, w = 1 - g - d, h(t, c(o))
        }

        function e(n, e, i, r) {
            return function(o) {
                return t(o, n, e, i, r, 1)
            }
        }
        n.setBezierFunction = function(t, i, r, o, a) {
            var u = e(i, r, o, a);
            return u.displayName = t, u.x1 = i, u.y1 = r, u.x2 = o, u.y2 = a, n.prototype.formula[t] = u
    ...
    function() {
        function t(t, e, i, r, o, a) {
            return n.tweenProps(r, e, t, i, 1, a, o)
        }
        var e = new n;
        e._filterArgs = [], n.interpolate = function(i, r, o, a, u) {
            var s = n.shallowCopy({}, i),
                c = u || 0,
                h = n.composeEasingObject(i, a || "linear");
            e.set({});
            var f = e._filterArgs;
            f.length = 0, f[0] = s, f[1] = i, f[2] = r, f[3] = h, n.applyFilter(e, "tweenCreated"), n.applyFilter(e, "beforeTween");
            var p = t(i, s, r, o, h, c);
            return n.applyFilter(e, "afterTween"), p
        }
    }(),
    function(t) {
        function n(t, n) {
            var e, i = [],
                r = t.length;
            for (e = 0; r > e; e++) i.push("_" + n + "_" + e);
            return i
        }

        function e(t) {
            var n = t.match(M);
            return n ? (1 === n.length || t[0].match(v)) && n.unshift("") : n = ["", ""], n.join(O)
        }

        function i(n) {
            t.each(n, function(t) {
                var e = n[t];
                "string" == typeof e && e.match(S) && (n[t] = r(e))
            })
        }
        ...
        function a(t) {
            return t = t.replace(/#/, ""), 3 === t.length && (t = t.split(""), t = t[0] + t[0] + t[1] + t[1] + t[2] + t[2]), b[0] = u(t.substr(0, 2)), b[1] = u(t.substr(2, 2)), b[2] = u(t.substr(4, 2)), b
        }
        ...
        function s(t, n, e) {
            var i = n.match(t),
                r = n.replace(t, O);
            if (i)
                for (var o, a = i.length, u = 0; a > u; u++) o = i.shift(), r = r.replace(O, e(o));
            return r
        }
        ...
        function h(t) {
            for (var n = t.match(F), e = n.length, i = t.match(I)[0], r = 0; e > r; r++) i += parseInt(n[r], 10) + ",";
        ...
        function p(n, e) {
            t.each(e, function(t) {
                for (var i = n[t], r = d(i), o = r.length, a = 0; o > a; a++) n[e[t].chunkNames[a]] = +r[a];
                delete n[t]
            })
        }
        ...
        function l(n, e) {
            t.each(e, function(t) {
                var i = n[t],
                    r = _(n, e[t].chunkNames),
                    o = m(r, e[t].chunkNames);
                i = w(e[t].formatString, o), n[t] = c(i)
            })
        }

        function _(t, n) {
            for (var e, i = {}, r = n.length, o = 0; r > o; o++) e = n[o], i[e] = t[e], delete t[e];
            return i
        }

        function m(t, n) {
            k.length = 0;
            for (var e = n.length, i = 0; e > i; i++) k.push(t[n[i]]);
            return k
        }

        function w(t, n) {
            for (var e = t, i = n.length, r = 0; i > r; r++) e = e.replace(O, +n[r].toFixed(4));
            return e
        }
        ...
        function g(n, e) {
            t.each(e, function(t) {
                ...
                if ("string" == typeof u) {
                    var s = u.split(" "),
                        c = s[s.length - 1];
                    for (i = 0; a > i; i++) n[o[i]] = s[i] || c
                } else
                    for (i = 0; a > i; i++) n[o[i]] = u;
                delete n[t]
            })
        }
        ...
        function y(n, e) {
            t.each(e, function(t) {
                var i = e[t],
                    ...
                    u = typeof a;
                if ("string" === u) {
                    for (var s = "", c = 0; o > c; c++) s += " " + n[r[c]], delete n[r[c]];
                    n[t] = s.substr(1)
                } else n[t] = a
            })
        }
        var v = /(\d|\-|\.)/,
            M = /([^\-0-9\.]+)/g,
            F = /[0-9.\-]+/g,
            T = RegExp("rgb\\(" + F.source + /,\s*/.source + F.source + /,\s*/.source + F.source + "\\)", "g"),
            I = /^.*\(/,
            S = /#([0-9]|[a-f]){3,6}/gi,
            O = "VAL",
            b = [],
        ...
        t.prototype.filter.token = {
            tweenCreated: function(t, n, e) {
                i(t), i(n), i(e), this._tokenData = f(t)
            },
            beforeTween: function(t, n, e, i) {
                g(i, this._tokenData), p(t, this._tokenData), p(n, this._tokenData), p(e, this._tokenData)
            },
            afterTween: function(t, n, e, i) {
                l(t, this._tokenData), l(n, this._tokenData), l(e, this._tokenData), y(i, this._tokenData)
            }
        }
    }(n)
}).call(null);
...
(function(factory) {
    ...
    jQuery.nanoGallery.defaultOptions = {
        ...
        debugMode: false,
        i18n: {
            'breadcrumbHome': 'TAOS II Galleries',
        ...
        */
        ...
        function ScrollbarSetVisible() {
            ...
            if (G.bodyOverflowInitial != null && G.bodyOverflowInitial != undefined) {
                jQuery('body').css({
                    overflow: G.bodyOverflowInitial
                });
            } else {
                jQuery('body').css({
                    overflow: 'auto'
        ...
        function userEventsGallery(element) {
            ...
            function OpenThumbnail(n) {
                ...
                if (typeof G.O.fnThumbnailClicked === 'function') {
                    if (!G.O.fnThumbnailClicked(G.I[n].$elt, G.I[n])) {
                        return;
                    }
                }
        ...
        function checkPluginParameters() {
            ...
            if (G.O.userID.toUpperCase() == 'CBRISBOIS@GMAIL.COM' || G.O.userID == '111186676244625461692') {
                if (G.O.blackList == '' || G.O.blackList.toUpperCase() == 'SCRAPBOOK|PROFIL') {
                    G.O.blackList = 'profil|scrapbook|forhomepage';
                }
            }

            if (G.O.blackList != '') {
                G.blackList = G.O.blackList.toUpperCase().split('|');
            }
            if (G.O.whiteList != '') {
                G.whiteList = G.O.whiteList.toUpperCase().split('|');
            }
            if (G.O.albumList != '') {
            ...
            if (G.O.photoset !== undefined) {
                if (G.O.photoset.length > 0) {
                    G.O.displayBreadcrumb = false;
                }
            } else {
                G.O.photoset = '';
            }
            ...
            if (G.O.thumbnailSizeSM !== undefined) {
                G.O.breakpointSizeSM = G.O.thumbnailSizeSM;
            }
            if (G.O.thumbnailSizeME !== undefined) {
                G.O.breakpointSizeME = G.O.thumbnailSizeME;
            }
            if (G.O.thumbnailSizeLA !== undefined) {
                G.O.breakpointSizeLA = G.O.thumbnailSizeLA;
            }
            if (G.O.thumbnailSizeXL !== undefined) {
                G.O.breakpointSizeXL = G.O.thumbnailSizeXL;
            }
            ...
            */
            ...
            if (toType(G.O.thumbnailWidth) == 'number') {
                ...
                var v = 'auto';
                if (ws[0].substring(0, 4) != 'auto') {
                    v = parseInt(ws[0]);
                }
                var c = 'u';
                if (ws[0].charAt(ws[0].length - 1) == 'C') {
                    c = 'c';
                }
        ...
        function RetrieveCurWidth() {
            ...
            if (G.O.breakpointSizeSM > 0 && vpW < G.O.breakpointSizeSM) {
                return 'xs';
            }
            if (G.O.breakpointSizeME > 0 && vpW < G.O.breakpointSizeME) {
                return 'sm';
            }
            if (G.O.breakpointSizeLA > 0 && vpW < G.O.breakpointSizeLA) {
                return 'me';
            }
            if (G.O.breakpointSizeXL > 0 && vpW < G.O.breakpointSizeXL) {
                return 'la';
            }
        ...
        function ThumbnailDefCaches() {
            ...
            G.curNavLevel = 'lN';
            var desc = '';
            if (G.O.thumbnailLabel.get('displayDescription')) {
                desc = 'd';
            }
            var item = NGAddItem('dummydummydummy', G.emptyGif, G.emptyGif, desc, '', 'image', '', '1', '0'),
                $newDiv = thumbnailBuild(item, 0, false).e$;
            ...
            if (G.custGlobals.oldBorderColor == '' || G.custGlobals.oldBorderColor == null || G.custGlobals.oldBorderColor == undefined) {
                G.custGlobals.oldBorderColor = '#000';
            }
        ...
        function PicasaProcessItems(albumIdx, processLocationHash, imageID, setLocationHash) {
            ...
            if (G.I[albumIdx].GetID() == 0) {
                ...
                // photos
                var opt = '';
                if (typeof G.I[albumIdx].customData.authkey !== 'undefined') {
                    opt = G.I[albumIdx].customData.authkey;
                }
        ...
        function PicasaParseData(albumIdx, data, kind) {
            ...
            jQuery.each(source, function(i, data) {
                ...
                var ok = true;
                if (kind == 'album') {
                    if (!CheckAlbumName(itemTitle, itemID)) {
                        ok = false;
                    }
                }
            ...
            if (G.O.displayBreadcrumb == true && !G.O.thumbnailAlbumDisplayImage) {
                ...
                if (l1 == 0) {
                    ...
                    if (l1 == 1 && G.O.breadcrumbAutoHideTopLevel) {
                        ...
                        tweenable.tween({
                            from: {
                                'opacity': G.$E.conNavBCon.css('opacity'),
                                'max-height': G.$E.conNavBCon.css('max-height')
                            },
                            to: {
                                'opacity': '0',
                                'max-height': '0px'
        ...
        function thumbnailsLazySetSrc() {
            ...
            jQuery($eltInViewport).each(function() {
                ...
                if ($image.attr('src') == G.emptyGif) {
                    ...
                    if (idx == undefined || G.I[idx] == undefined) {
                        return;
                    }
                    $image.attr('src', '');
        ...
        function renderGallery2(albumIdx, pageNumber, onComplete) {
            ...
            if (albumIdx == -1 || G.I[albumIdx] == undefined) {
                return;
            }
                            ...
                            if (G.O.thumbnailLazyLoad && !r.cIS) {
                                if (!endInViewportTest) {
                                    if (inViewport($newDiv, G.tn.lazyLoadTreshold)) {
                                        ...
                                        if (startInViewportTest) {
                                            endInViewportTest = true;
                                        }
                                    }
                                }
                            }
        ...
        function thumbnailBuild(item, idx, foundDesc) {
            ...
            var checkImageSize = false,
                src = G.emptyGif;
            if ((G.tn.settings.getH() == 'auto' && G.I[idx].thumbImg().height == 0) || (G.tn.settings.getW() == 'auto' && G.I[idx].thumbImg().width == 0)) {
                checkImageSize = true;
            }
            ...
            if (item.kind == 'album') {
                ...
                // IMAGE
                if (G.O.thumbnailLabel.get('display') == true) {
                    if (foundDesc && sDesc.length == 0 && G.O.thumbnailLabel.get('position') == 'onBottom') {
                        sDesc = '&nbsp;';
                    }
                    newElt[newEltIdx++] = '<div class="labelImage nGEvent" style="width:' + G.tn.settings.getW() + 'px;' + (G.O.RTL ? "direction:RTL;" : "") + (G.curNavLevel == 'l1' ? G.tn.styleL1LabelImage : G.tn.styleLabelImage) + '"><div class="labelImageTitle labelTitle nGEvent" style="' + (G.curNavLevel == 'l1' ? G.tn.styleL1ITitle : G.tn.styleITitle) + '">' + sTitle + '</div></div>';
                }
            }
            ...
            if (checkImageSize) {
                ...
                gi_imgLoad.on('always', function(instance) {
                    ...
                    if (item == undefined || instance.images[0].img.src == G.emptyGif) {
                        return;
                    } // warning: also fired for blank image --> ignore
                    var b = false;
        ...
        function setThumbnailSize($elt, item) {
            ...
            if (G.tn.settings.getW() == 'auto') {
                ...
                if (item.thumbImg().width > 0) {
                    ...
                    item.$getElt('.imgContainer').width(G.tn.settings.getH() * ratio).css({
                        overflow: 'hidden'
                    });
                    if (G.O.thumbnailLabel.get('position') == 'onBottom') {
            ...
            switch (G.O.thumbnailLabel.get('position')) {
                case 'onBottom':
                    ...
                    if (G.tn.settings.getH() == 'auto') {
                        // line break
                        if (item.kind == 'album') {
                            item.$getElt('.labelFolderTitle').css({
                                'white-space': 'normal'
                            });
                        } else {
                            item.$getElt('.labelImageTitle').css({
                                'white-space': 'normal'
                            });
                        }
                        item.$getElt('.labelDescription').css({
                            'white-space': 'normal'
                        });
                    } else {
                        // no line break
        ...
        function ThumbnailOverInit($e) {
            ...
            if (n == undefined) {
                return;
            } // required because can be fired on ghost elements
            var item = G.I[n];
            ...
            for (j = 0; j < G.tn.getHE().length; j++) {
                switch (G.tn.getHE()[j].name) {
                    ...
                    case 'imageScale150Outside':
                        ...
                        item.$getElt('.subcontainer').css({
                            overflow: 'visible'
                        });
                        item.$getElt('.imgContainer').css({
                            overflow: 'visible'
                        });
                    ...
                    case 'imageFlipHorizontal':
                        switch (G.O.thumbnailLabel.get('position')) {
                            case 'overImageOnTop':
                                item.$getElt('.labelImage').css({
                                    top: -G.tn.imgcBorderHeight / 2,
                                    bottom: G.tn.imgcBorderWidth / 2,
                                    left: 0,
                                    right: 0
                                });
                                break;
                ...
                for (var i = 0; i < transform.length; i++) {
                    ...
                    if (typeof anime[tf] !== 'undefined') {
                        ...
                        tweenable.tween({
                            ...
                            from: {
                                'v': parseInt(item.eltTransform[eltClass][tf])
                            },
                            to: {
                                'v': to
                            },
                ...
                for (j = 0; j < G.tn.getHE().length; j++) {
                    switch (G.tn.getHE()[j].name) {
                        case 'imageSplit4':
                            var $t = item.$getElt('.imgContainer');
                            TnAni($t.eq(0), j, {
                                translateX: -item.thumbFullWidth / 2,
                                translateY: -item.thumbFullHeight / 2
                            }, item, 'imgContainer0');
                            TnAni($t.eq(1), j, {
                                translateX: item.thumbFullWidth / 2,
                                translateY: -item.thumbFullHeight / 2
                        ...
                        case 'scaleLabelOverImage':
                            TnAni(item.$getElt('.labelImage'), j, {
                                scale: 100 / dscale,
                                opacity: '1'
                            }, item, 'labelImage0');
                            TnAni(item.$getElt('.imgContainer'), j, {
                                scale: 50 / dscale
                            }, item, 'imgContainer0');
                            break;
                        ...
                        case 'slideUp':
                            TnAni(item.$getElt('.imgContainer'), j, {
                                translateY: -item.thumbFullHeight
                            }, item, 'imgContainer0');
                            TnAni(item.$getElt('.labelImage'), j, {
                                translateY: 0
                            }, item, 'labelImage0');
                        ...
                        case 'slideRight':
                            TnAni(item.$getElt('.imgContainer'), j, {
                                translateX: item.thumbFullWidth
                            }, item, 'imgContainer0');
                            TnAni(item.$getElt('.labelImage'), j, {
                                translateX: 0
                            }, item, 'labelImage0');
                        ...
                        case 'labelAppear':
                            if (G.aengine == 'velocity') {
                                TnAni(item.$getElt('.labelImage'), j, {
                                    backgroundColorRed: G.custGlobals.oldLabelRed,
                                    backgroundColorGreen: G.custGlobals.oldLabelGreen,
                                    backgroundColorBlue: G.custGlobals.oldLabelBlue,
                            ...
                            if (item.kind == 'album') {
                                TnAni(item.$getElt('.labelFolderTitle'), j, {
                                    opacity: '1'
                                }, item);
                            } else {
                                TnAni(item.$getElt('.labelImageTitle'), j, {
                                    opacity: '1'
                                }, item);
                            }
                            TnAni(item.$getElt('.labelDescription'), j, {
                                opacity: '1'
                            }, item);
                            break;
                        ...
                        case 'borderLighter':
                            if (G.aengine == 'velocity') {
                                ...
                                TnAni($e, j, {
                                    borderColorRed: co[0],
                                    borderColorGreen: co[1],
                                    borderColorBlue: co[2],
                                    colorAlpha: co[3]
                                }, item);
                            } else {
                                ...
                                TnAni($e, j, {
                                    borderColor: lighterColor(c, 0.5)
                                }, item);
                            }
                            break;
                        ...
                        case 'borderDarker':
                            if (G.aengine == 'velocity') {
                                ...
                                $e.data('ngcache_borderColor', c);
                                TnAni($e, j, {
                                    borderColor: darkerColor(c, 0.5)
                                }, item);
                            }
                            break;

                        case 'imageScale150':
                            TnAni(item.$getElt('img'), j, {
                                scale: 150 / dscale
                            }, item, 'img0');
                            break;
                        ...
                        case 'imageSlide2Random':
                            switch (item.customData.hoverEffectRDir) {
                                ...
                                case 'imageSlide2Left':
                                    TnAni(item.$getElt('img'), j, {
                                        translateX: -item.thumbFullWidth * .1
                                    }, item, 'img0');
                                    break;
                                case 'imageSlide2Right':
                                    TnAni(item.$getElt('img'), j, {
                                ...
                                case 'imageSlide2UpRight':
                                    TnAni(item.$getElt('img'), j, {
                                        translateY: -item.thumbFullHeight * .05,
                                        translateX: item.thumbFullWidth * .05
                                    }, item, 'img0');
                                    break;
                                case 'imageSlide2UpLeft':
                                    TnAni(item.$getElt('img'), j, {
            ...
            try {
                for (j = 0; j < G.tn.getHE().length; j++) {
                    switch (G.tn.getHE()[j].name) {
                        ...
                        case 'scaleLabelOverImage':
                            TnAniO(item.$getElt('.labelImage'), j, {
                                opacity: '0',
                                scale: 50 / dscale
                            }, item, 'labelImage0');
                            TnAniO(item.$getElt('.imgContainer'), j, {
                                scale: 100 / dscale
                            }, item, 'imgContainer0');
                            break;
                        ...
                        case 'labelAppear75':
                            ...
                            if (item.kind == 'album') {
                                TnAniO(item.$getElt('.labelFolderTitle'), j, {
                                    opacity: '0'
                                });
                            } else {
                                TnAniO(item.$getElt('.labelImageTitle'), j, {
                                    opacity: '0'
                                });
                            }
                            TnAniO(item.$getElt('.labelDescription'), j, {
                                opacity: '0'
                            });
                            break;
                        ...
                        case 'labelOpacity50':
                            TnAniO(item.$getElt('.labelImage'), j, {
                                opacity: G.custGlobals.oldLabelOpacity
                            });
                            break;
                        ...
                        case 'borderDarker':
                            if (G.aengine == 'velocity') {
                                ...
                                TnAniO($e, j, {
                                    borderColor: $e.data('ngcache_borderColor')
                                });
                            }
                            break;
        ...
        function OpenInternalViewer(imageIdx) {
            ...
            $closeB.on("touchstart click", function(e) {
                ...
                e.preventDefault();
                e.stopPropagation();
                if ((new Date().getTime()) - G.timeImgChanged < 400) {
                    return;
                }
                CloseInternalViewer(true);
                return false;
            ...
            G.$E.conVwTb.find('.nextButton').on("touchstart click", function(e) {
                e.stopPropagation();
                DisplayNextImagePart1();
            });
            G.$E.conVwTb.find('.previousButton').on("touchstart click", function(e) {
                e.stopPropagation();
                DisplayPreviousImage();
            });
            G.$E.vwContent.find('.contentAreaNext').on("touchstart click", function(e) {
                e.stopPropagation();
                DisplayNextImagePart1();
            });
            G.$E.vwContent.find('.contentAreaPrevious').on("touchstart click", function(e) {
                e.stopPropagation();
                DisplayPreviousImage();
            });
            ...
            G.$E.conVw.find('.image').attr('draggable', 'false').attr('unselectable', 'on').css({
            ...
            if (G.O.slideshowAutoStart) {
                ...
                DisplayNextImage();
                G.playSlideshowTimerID = window.setInterval(function() {
                    DisplayNextImage();
                }, G.slideshowDelay);
            }
        ...
        function ToolbarSetItemsVisibility(curMode) {
            ...
            for (var i = 0, l = v.length; i < l; i++) {
                if (v[i] == 'label') {
                    if (G.$E.conVwTb.find('.title').text() == '' && G.$E.conVwTb.find('.description').text() == '') {
                        G.$E.conVwTb.find('.' + v[i]).css({
                            display: 'none'
                        });
                    } else {
                        G.$E.conVwTb.find('.' + v[i]).css({
                            display: (t.indexOf(v[i]) >= 0 ? 'table-cell' : 'none')
                        });
                    }
                } else {
                    G.$E.conVwTb.find('.' + v[i]).css({
            ...
            // custom elements
            G.$E.conVwTb.find('.ngCustomBtn').css({
                display: 'none'
            });
            var vC = t.split(',');
        ...
        function DisplayNextImage() {
            ...
            if ((new Date().getTime()) - G.timeImgChanged < 300) {
                return;
            }
            var l = G.I.length;
        ...
        function DisplayInternalViewer(imageIdx, displayType) {
            ...
            if (displayType == '') {
                ...
                G.$E.vwImgC.css({
                    ...
                    left: 0,
                    visibility: 'visible'
                }).attr('src', G.emptyGif).attr('src', G.I[imageIdx].responsiveURL());
                ...
                switch (G.O.imageTransition) {
                    ...
                    case 'slideBETA':
                        ...
                        if (G.CSStransformName == null) {
                            ...
                            jQuery.when(
                                G.$E.vwImgC.animate({
                                    left: (displayType == 'nextImage' ? -getViewport().w : getViewport().w) + 'px',
                                    opacity: 0
                                }, 500),
                                $new.animate({
                                    opacity: 1
                            ...
                            var to = {
                                v: (displayType == 'nextImage' ? -getViewport().w : getViewport().w)
                            };
                            jQuery(from).animate(to, {
                                ...
                                step: function(currentValue) {
                                    ...
                                    G.$E.vwImgC.css({
                                        opacity: (1 - Math.abs(currentValue / dir))
                                    });
                    ...
                    case 'slide':
                        ...
                        if (G.CSStransformName == null) {
                            ...
                            jQuery.when(
                                G.$E.vwImgC.animate({
                                    left: ((displayType == 'nextImage' ? -getViewport().w : getViewport().w) * 2) + 'px'
                                }, 500),
                                $new.animate({
                                    opacity: 1
                                }, 300)
                            ...
                            tweenable.tween({
                                ...
                                to: {
                                    t: (displayType == 'nextImage' ? -getViewport().w : getViewport().w)
                                },
                                attachment: {
                                    idx: imageIdx,
                                    dT: displayType,
        ...
        function DisplayInternalViewerComplete(imageIdx, displayType) {
            ...
            if (typeof G.O.fnImgDisplayed === 'function') {
                if (!G.O.fnImgDisplayed(G.I[imageIdx].$elt, G.I[imageIdx])) {
                    return;
                }
            }
            ...
            //console.log("type = "+G.I[imageIdx].src);
            if (G.I[imageIdx].src.split('.').pop() == "mp4") {
                $(".imgCurrent").css({ visibility:'hidden'});
                $(".content").append('<video class="image nGEvent" style="position:absolute; top:0; bottom:0; left:0; right:0; margin:auto;" controls><source src="https://lh3.googleusercontent.com/yodedFuqc7r6bhb9sO2Tx4s4mftXS5aBbgQV4OBVHB1T=m18" type="video/mp4"></video>');
                //$(".toolbarContainer").css({  visibility:'visible' });
            } else {
                $("video").remove();
                //console.log("type = "+G.I[imageIdx].src.split('.').pop());
            }
            G.$E.vwImgN.css({
                opacity: 0,
                left: 0,
                visibility: 'hidden'
            }).attr('src', G.emptyGif).attr('src', G.I[GetNextImageIdx(imageIdx)].responsiveURL());
            ...
            G.$E.vwImgP.css({
                ...
                left: 0,
                visibility: 'hidden'
            }).attr('src', G.emptyGif).attr('src', G.I[GetPreviousImageIdx(imageIdx)].responsiveURL());
        ...
        function ResizeInternalViewer() {
            ...
            if ((new Date().getTime()) - G.viewerResizeTimerLastRun < 100) {
                return;
            }
            ...
            window.requestAnimationFrame(function() {
                ...
                G.$E.conVwTb.css({
                    height: tb_OHt
                }); // resize toolbar container to toolbar size


                G.$E.vwContent.children('img').css({
                    'max-width': (w - tH),
                    'max-height': (h - tV)
                });
        ...
        function SetColorScheme(element) {
            ...
            if (cs.navigationbar.border !== undefined) {
                s += s1 + '.nanoGalleryNavigationbar { border:' + cs.navigationbar.border + ' !important; }' + '\n';
            }
            if (cs.navigationbar.borderTop !== undefined) {
                s += s1 + '.nanoGalleryNavigationbar { border-top:' + cs.navigationbar.borderTop + ' !important; }' + '\n';
            }
            if (cs.navigationbar.borderBottom !== undefined) {
                s += s1 + '.nanoGalleryNavigationbar { border-bottom:' + cs.navigationbar.borderBottom + ' !important; }' + '\n';
            }
            if (cs.navigationbar.borderRight !== undefined) {
                s += s1 + '.nanoGalleryNavigationbar { border-right:' + cs.navigationbar.borderRight + ' !important; }' + '\n';
            }
            if (cs.navigationbar.borderLeft !== undefined) {
                s += s1 + '.nanoGalleryNavigationbar { border-left:' + cs.navigationbar.borderLeft + ' !important; }' + '\n';
            }
        ...
        function nanoConsoleLog(msg) {
            if (window.console) {
                console.log('nanoGALLERY: ' + msg + ' [' + G.baseEltID + ']');
            }
        };
        ...
        function inViewport($elt, threshold) {
            ...
            if (eltOS.top >= (wp.t - threshold) && (eltOS.top + th) <= (wp.t + wp.h + threshold) && eltOS.left >= (wp.l - threshold) && (eltOS.left + tw) <= (wp.l + wp.w + threshold)) {
                return true;
            } else {
                return false;
            }
